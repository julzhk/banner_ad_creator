...
class HTMXbannerAdListView(generic.ListView):
...
class HTMXbannerAdCreateView(generic.CreateView):
    model = models.bannerAd
    form_class = forms.bannerAdForm
...
class HTMXbannerAdDeleteView(generic.DeleteView):
    model = models.bannerAd
    success_url = reverse_lazy("app_bannerAd_htmx_list")
...
class HTMXEmotionListView(generic.ListView):
...
class HTMXEmotionCreateView(generic.CreateView):
    model = models.Emotion
    form_class = forms.EmotionForm
...
class HTMXEmotionDeleteView(generic.DeleteView):
    model = models.Emotion
    success_url = reverse_lazy("app_Emotion_htmx_list")
