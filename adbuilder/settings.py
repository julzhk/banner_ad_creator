"""
Django settings for adbuilder project.
...
WSGI_APPLICATION = 'adbuilder.wsgi.application'
...
if os.environ.get('LOCAL_FONTS') == 'local':
    FONTS = ['Optima', 'Sans', 'Serif', 'Arial', 'Helvetica',
             'Times', 'Courier', 'Verdana', 'Georgia', 'Palatino',
             'Garamond', 'Bookman', 'Comic', 'Trebuchet', 'Arial',
