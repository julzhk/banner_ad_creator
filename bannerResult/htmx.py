...
class HTMXResultListView(generic.ListView):
    model = models.Result
...
class HTMXResultCreateView(generic.CreateView):
    model = models.Result
    form_class = forms.ResultForm
...
class HTMXResultDeleteView(generic.DeleteView):
    model = models.Result
    success_url = reverse_lazy("app_Result_htmx_list")
